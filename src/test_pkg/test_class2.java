...
public static void execute() throws IOException {
	for (int i=0; i<5; i++) //retry method
	{
		...
		String requestBody=req_rep_class.post_req3();
		...
		if (statusCode==201) {
			...
			test_class2.validator(responsebody , requestBody,statusCode);
			utility_common_function.EvidenceCreator("test_class2", responsebody, requestBody);
			break;
		}
		else {
...
public static void validator(String responsebody,String requestBody, int statusCode) 
 {
